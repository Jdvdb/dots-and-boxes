...
def main():
    ...
    for i in range(len(row_borders)):
        for j in range(len(row_borders[i])):
            row_borders[i][j] = pygame.Rect((260+j*DOT_SPACING,145+i*DOT_SPACING),(DOT_SPACING - 2*DOT_RADIUS, DOT_RADIUS))
            
    
    for i in range(len(col_borders)):
        for j in range(len(col_borders[i])):
            col_borders[i][j] = pygame.Rect((245+i*DOT_SPACING,160+j*DOT_SPACING),(DOT_RADIUS, DOT_SPACING - 2*DOT_RADIUS))
            
    for i in range(len(boxes)):
        for j in range(len(boxes[i])):
            boxes[i][j] = pygame.Rect((250+i*DOT_SPACING, 150+j*DOT_SPACING),(100,100))
